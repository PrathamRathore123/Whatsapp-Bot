...
describe('MessageHandler', () => {
  ...
  describe('handleIncomingMessage', () => {
    ...
    test('should handle book my trip command', async () => {
      ...
      expect(mockSendMessage).toHaveBeenCalledWith(
        '1234567890@c.us',
        "✅ Great! Your booking request has been forwarded to our executive team. They will contact you shortly to finalize your trip details and payment. Thank you for choosing WanderWorld Travels!"
      );
    });
